...
if st.session_state.is_full_data:
    ...
    with col01:
        st.markdown(f"<p style='color: #6C6C6C; margin-bottom: 5px;'>總ID數量：13,083,155</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C; margin-bottom: 5px;'>曾經為要保人：7,973,887、約60.95％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C; margin-bottom: 5px;'>曾經為被保人：10,533,736、約80.51％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C; margin-bottom: 5px;'>曾經為理賠事故人：5,108,874、約39.05％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C; margin-bottom: 5px;'>曾經為員工：107,202、約0.82％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C; margin-bottom: 5px;'>曾經意外險被保人：1,887,550、約14.43％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C; margin-bottom: 5px;'>官網會員：4,167,135、約31.85％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C; margin-bottom: 5px;'>MML會員：2,738,528、約20.93％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C; margin-bottom: 5px;'>FitBack會員：1,103,733、約8.44％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C; margin-bottom: 5px;'>有旅平險：222,054、約1.7％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C; margin-bottom: 5px;'>至少一項服務通路：7,460,847、約57.03％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C; margin-bottom: 5px;'>什麼都沒有的人(沒旅平沒會員沒MML沒FitBack沒服務軌跡)：5,399,658、約41.27％</p>", unsafe_allow_html=True)

    with col02:
        st.write(f"**各通路接觸次數**")
        st.markdown(f"<p style='color: #6C6C6C; margin-bottom: 5px;'>有業務員服務：4,682,902、約35.79％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C; margin-bottom: 5px;'>有直效服務：1,076,883、約8.23％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C; margin-bottom: 5px;'>有服務中心櫃台服務：212,641、約1.63％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C; margin-bottom: 5px;'>有官網服務：755,664、約5.78％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C; margin-bottom: 5px;'>有MML服務：2,436,348、約18.62％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C; margin-bottom: 5px;'>有電話_0800服務：552,953、約4.23％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C; margin-bottom: 5px;'>有電話_0900服務：366,554、約2.8％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C; margin-bottom: 5px;'>有簡訊服務：4,603,983、約35.19％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C; margin-bottom: 5px;'>有停效催繳提醒服務：1,370,616、約10.48％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C; margin-bottom: 5px;'>有MAIL HUNTER服務：4,096,772、約31.31％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C; margin-bottom: 5px;'>有BILL HUNTER服務：3,080,889、約23.55％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C; margin-bottom: 5px;'>有LINE服務：72,398、約0.55％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C; margin-bottom: 5px;'>有行銷網站服務：84,594、約0.65％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C; margin-bottom: 5px;'>有紙本通知服務：2,912,952、約22.26％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C; margin-bottom: 5px;'>有放款業務服務：453,594、約3.47％</p>", unsafe_allow_html=True)

    with col03:
        st.write(f"**其他大盤數據**")
        st.markdown(f"<p style='color: #6C6C6C; margin-bottom: 5px;'>FitBack樂想家：946,995、約7.24％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C; margin-bottom: 5px;'>FitBack探索家：29,929、約0.23％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C; margin-bottom: 5px;'>FitBack實踐家：39,884、約0.3％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C; margin-bottom: 5px;'>FitBack有上傳步數人數：410,277、約3.14％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C; margin-bottom: 5px;'>FitBack平均步數：918,598.21</p>", unsafe_allow_html=True)
else:
