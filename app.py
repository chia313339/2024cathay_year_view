...
if st.session_state.is_full_data:
    ...
    with col03:
        ...
        st.markdown(f"<p style='color: #6C6C6C;'>[C2]敏捷雪豹：357,648、約8.5％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C;'>[C3]悠遊獨角鯨：286,668、約6.81％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C;'>[C4]安逸玄武：317,375、約7.54％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C;'>[C5]無懼雷鳥：100,144、約2.38％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C;'>[C6]膽識鳳凰：253,478、約6.02％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C;'>[C7]睿智九尾狐：218,651、約5.19％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C;'>[C8]精明靈蛇：282,827、約6.72％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C;'>[C9]仙境白澤：549,199、約13.05％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C;'>[C10]共濟神狼：583,212、約13.85％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C;'>[C11]機敏麒麟：601,482、約14.29％</p>", unsafe_allow_html=True)
        st.markdown(f"<p style='color: #6C6C6C;'>[C12]原野金羊毛獸：618,846、約14.7％</p>", unsafe_allow_html=True)
